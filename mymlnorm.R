#' mymlnorm
#'
#' @description Function to find maximum likelihood estimates for the population mean and standard deviation.
#' graphs solution for estimated population mean and standard deviation.
#' @param x data
#' @param mu mean
#' @param sig
#' @param ...
